...
public class AwsUploader implements Runnable, MultipleFileUpload {
	...
	public AwsUploader(File file){
		...
		try{
			...
			s3Handle = new AmazonS3Client(new PropertiesCredentials(file1));
...
//		try {
//			System.err.println("dirHandle" + dirHandle + " : " + dirHandle.getCanonicalPath());
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
...
//			System.err.println("User email = " + val);
	...
	public boolean recursiveDelete(File file)
	{
		if(file.isDirectory())
		{
			...
			{
//				System.out.println("File name " + eachFile);
