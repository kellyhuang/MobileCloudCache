...
public class AwsAppBrokerIntfMsg {
	...
	public static final int		GET_LIST_IMAGE_CODE = 0;
	public static final int		GET_LIST_AUDIO_CODE = 1;
	public static final int		GET_LIST_VIDEO_CODE = 2;
	public static final int		GET_LIST_DATA_FILE_CODE = 3;
